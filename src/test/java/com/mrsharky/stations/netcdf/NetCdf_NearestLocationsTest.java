 ...
 * @author mrsharky
 */
public class NetCdf_NearestLocationsTest {
        ...
        for (double minDistance : minDistances) {
            for (int minMonthYear : minMonthYears) {
                for (String input : inputs) {
                    String destination = "Results/Points/source=1900-1930-JulSub." + input + "/km=" + minDistance + "/yrs=" + minMonthYear + "";
                    ...
                    if (!stationFile.exists()) {
                        ...
                        String lowerBaseline = "1900-12-31";
                        String upperBaseline = "1930-12-31";
