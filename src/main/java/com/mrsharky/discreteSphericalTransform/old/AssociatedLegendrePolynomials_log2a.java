 ...
 * @author dafre
 */
public class AssociatedLegendrePolynomials_log2a {
    ...
    public Double AssLegFunc2(int l, int m, double x, boolean negativeX) {
        ...
        if (alreadyCalculated) {
            ...
            if (!_log) {
                ...
                Complex left  = left1.add(left2).add(left3).add(divisor).exp();
                ...
                double right  = Math.exp(right2.add(right1).add(right3).add(divisor).getReal());
    ...
    public AssociatedLegendrePolynomials_log2a(int N, double X) {
    ...
    public static void main(String args[]) throws Exception {
        ...
        AssociatedLegendrePolynomials_log2a leg = new AssociatedLegendrePolynomials_log2a(153,x);
