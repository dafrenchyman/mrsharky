 ...
 * @author dafre
 */
public class DiscreteSphericalTransform_new2 {
    ...
    public DiscreteSphericalTransform_new2(double[][] DATA, int Q, boolean GAUSQUADon) throws Exception {
        int M = DATA.length+1;
        int N = DATA[0].length;
        ...
        for (int k = 0; k <= Q; k++) {
            ...
            for (int l = 0; l <= k; l++) {
                ...
                for (int t = 0; t < theta.length; t++) {
                    ...
                    Complex[] pklLog = ComplexArray.Log(pkl);
    ...
    public static void main(String args[]) throws Exception {
        ...
        int Q = 10;
        DiscreteSphericalTransform_new2 dst = new DiscreteSphericalTransform_new2(DATA, Q, true);
