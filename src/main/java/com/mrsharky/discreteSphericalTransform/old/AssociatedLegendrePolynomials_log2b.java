 ...
 * @author dafre
 */
public class AssociatedLegendrePolynomials_log2b {
    ...
    public Double AssLegFunc2(int l, int m, double x, boolean negativeX) {
        ...
        if (alreadyCalculated) {
            ...
            if (!_log) {
                ...
                Complex A  = left1.add(left2).add(left3).add(divisor);
                ...
                Complex C  = right2.add(right1).add(divisor);
                ...
                //Complex CA = (C.add(A.multiply(-1.0))).exp().multiply(-1.0).add(1).log();
                double CA = Math.log1p((C.add(A.multiply(-1.0))).exp().multiply(-1.0).getReal());
                
                Complex value1 = A.add(CA);
                value = value1.getReal();
            }
    ...
    public AssociatedLegendrePolynomials_log2b(int N, double X) {
    ...
    public static void main(String args[]) throws Exception {
        ...
        LegendreGausWeights lgwt = new LegendreGausWeights(4, -1.0, 1.0);     
        ...
        AssociatedLegendrePolynomials_log2b leg = new AssociatedLegendrePolynomials_log2b(10,x);
