 ...
 */
public class NetCdfAnomaly_NoDiff {
    ...
    public NetCdfAnomaly_NoDiff(Map<Date, double[][]> allData, Date baselineLower, Date baselineUpper) {
        ...
        for (int month = 0; month <= 12; month++) {
            ...
            for (int latCounter = 0; latCounter < numLats; latCounter++) {
                for (int lonCounter = 0; lonCounter < numLons; lonCounter++) {
                    ...
                    gridBoxAnomalyMean3[latCounter][lonCounter] = 0.0;
